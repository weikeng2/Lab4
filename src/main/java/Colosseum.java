...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while (tempPokemon.attackLevel < 1 || tempPokemon.attackLevel > MAX_ATTACK_LEVEL) {
            System.out.print("Sorry. The attack level must be between 1 and 49: ");
            tempPokemon.attackLevel = myScan.nextInt();
        }

        System.out.print("Enter your defense level (1-" + (MAX_ATTACK_LEVEL - tempPokemon.attackLevel)+ ": ");
        tempPokemon.defenseLevel = myScan.nextInt();
        while (tempPokemon.defenseLevel < 1 || tempPokemon.defenseLevel > (MAX_ATTACK_LEVEL - tempPokemon.attackLevel) {
            System.out.print("Sorry. The defense level must be between 1 and " + (MAX_ATTACK_LEVEL - tempPokemon.attackLevel) + ": ");
            tempPokemon.defenseLevel = myScan.nextInt();
        }
        return tempPokemon;
    }
    ...
    public static void printWhoIsAhead() {
        ...
        if (firstPokemon.hitPoints > secondPokemon.hitPoints) {
            ...
            System.out.println(firstPokemon.name + " and " + secondPokemon.name + " are currently tied!");
        }
    }
